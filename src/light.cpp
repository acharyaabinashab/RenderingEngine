...
void Light::renderToShader(Shader& shader, Camera& camera)
{
    ...
    if(this->lightType == "point")
    {
        ...
        glUniform3f(glGetUniformLocation(shader.ID, ("lightPointArray["+ std::to_string(this->lightPointID) +"].position").c_str()), lightPositionViewSpace.x, lightPositionViewSpace.y, lightPositionViewSpace.z);
        glUniform4f(glGetUniformLocation(shader.ID, ("lightPointArray["+ std::to_string(this->lightPointID) +"].color").c_str()), this->lightColor.r, this->lightColor.g, this->lightColor.b, this->lightColor.a);
        glUniform1f(glGetUniformLocation(shader.ID, ("lightPointArray["+ std::to_string(this->lightPointID) +"].radius").c_str()), this->lightRadius);
    }
    ...
    else if(this->lightType == "directional")
    {
        ...
        glUniform3f(glGetUniformLocation(shader.ID, ("lightDirectionalArray["+ std::to_string(this->lightDirectionalID) +"].direction").c_str()), lightDirectionViewSpace.x, lightDirectionViewSpace.y, lightDirectionViewSpace.z);
        glUniform4f(glGetUniformLocation(shader.ID, ("lightDirectionalArray["+ std::to_string(this->lightDirectionalID) +"].color").c_str()), this->lightColor.r, this->lightColor.g, this->lightColor.b, this->lightColor.a);
    }
}
